local config_opts = {}
local defaults = {enabled = true, mode = "smart", trail_highlight = true, trail_highlight_group = "Whitespace", forceBalance = false, commentChar = ";", stringDelimiters = {"\""}, lispVlineSymbols = false, lispBlockComments = false, guileBlockComments = false, schemeSexpComments = false, janetLongStrings = false}
